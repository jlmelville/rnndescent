...
#> 05:58:06 Initializing from random neighbors
#> 05:58:06 Generating random k-nearest neighbor graph from reference with k = 4
#> 05:58:06 Searching nearest neighbor graph with epsilon = 0.1 and max_search_fraction = 1
#> 05:58:06 Finished
```
