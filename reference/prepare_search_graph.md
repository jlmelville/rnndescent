...
#> 16:42:25 Initializing from random neighbors
#> 16:42:25 Generating random k-nearest neighbor graph from reference with k = 4
#> 16:42:25 Searching nearest neighbor graph with epsilon = 0.1 and max_search_fraction = 1
#> 16:42:25 Finished
```
