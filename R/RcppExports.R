...
rp_tree_knn_cpp <- function(data, nnbrs, metric, leaf_size = 30L, angular = FALSE, n_threads = 0L, verbose = FALSE) {
    .Call(`_rnndescent_rp_tree_knn_cpp`, data, nnbrs, metric, leaf_size, angular, n_threads, verbose)
}
