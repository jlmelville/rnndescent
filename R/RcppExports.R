...
nn_descent <- function(data, idx, dist, metric = "euclidean", max_candidates = 50L, n_iters = 10L, delta = 0.001, rho = 0.5, use_set = FALSE, fast_rand = FALSE, parallelize = FALSE, verbose = FALSE) {
