...
merge_nn <- function(nn_idx1, nn_dist1, nn_idx2, nn_dist2, is_query, parallelize, block_size, grain_size = 1L, verbose = FALSE) {
    .Call(`_rnndescent_merge_nn`, nn_idx1, nn_dist1, nn_idx2, nn_dist2, is_query, parallelize, block_size, grain_size, verbose)
}

merge_nn_all <- function(nn_graphs, is_query, parallelize, block_size, grain_size = 1L, verbose = FALSE) {
