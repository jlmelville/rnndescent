...
diversify_cpp <- function(data, graph_list, metric = "euclidean", prune_probability = 1.0, n_threads = 0L) {
...
degree_prune_cpp <- function(graph_list, max_degree, n_threads = 0L) {
