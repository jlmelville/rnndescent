...
rnn_brute_force_query <- function(x, y, k, metric = "euclidean", parallelize = FALSE, grain_size = 1L, verbose = FALSE) {
    .Call(`_rnndescent_rnn_brute_force_query`, x, y, k, metric, parallelize, grain_size, verbose)
}
