...
The default value is `0.1`. The larger the value, the more back-tracking is
permitted. The exact meaning of the value is related to how large a distance is
considered "close enough" the current neighbor list of the query to be worth
exploring.
