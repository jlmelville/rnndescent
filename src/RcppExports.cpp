...
Rcpp::List rnn_brute_force_query(Rcpp::NumericMatrix x, Rcpp::NumericMatrix y, int k, const std::string& metric, bool parallelize, std::size_t grain_size, bool verbose);
RcppExport SEXP _rnndescent_rnn_brute_force_query(SEXP xSEXP, SEXP ySEXP, SEXP kSEXP, SEXP metricSEXP, SEXP parallelizeSEXP, SEXP grain_sizeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< std::size_t >::type grain_size(grain_sizeSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(rnn_brute_force_query(x, y, k, metric, parallelize, grain_size, verbose));
    return rcpp_result_gen;
END_RCPP
}
// nn_descent
