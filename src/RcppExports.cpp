...
RcppExport SEXP _rnndescent_nn_descent_cpp(SEXP idxSEXP, SEXP distSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(nn_descent_cpp(idx, dist));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_rnndescent_nn_descent_cpp", (DL_FUNC) &_rnndescent_nn_descent_cpp, 2},
    {NULL, NULL, 0}
};
