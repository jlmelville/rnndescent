...
Rcpp::List rnn_brute_force(Rcpp::NumericMatrix data, int k,
                           ...
                           bool verbose);
RcppExport SEXP _rnndescent_rnn_brute_force(
    SEXP dataSEXP, SEXP kSEXP, SEXP metricSEXP, SEXP parallelizeSEXP,
    SEXP block_sizeSEXP, SEXP grain_sizeSEXP, SEXP verboseSEXP) {
  BEGIN_RCPP
  ...
  rcpp_result_gen = Rcpp::wrap(rnn_brute_force(
      data, k, metric, parallelize, block_size, grain_size, verbose));
...
RcppExport SEXP _rnndescent_rnn_brute_force_query(
    SEXP xSEXP, SEXP ySEXP, SEXP kSEXP, SEXP metricSEXP, SEXP parallelizeSEXP,
    SEXP block_sizeSEXP, SEXP grain_sizeSEXP, SEXP verboseSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen = Rcpp::wrap(rnn_brute_force_query(
      x, y, k, metric, parallelize, block_size, grain_size, verbose));
  return rcpp_result_gen;
  END_RCPP
}
// nn_descent
...
// nn_descent_query
Rcpp::List nn_descent_query(Rcpp::NumericMatrix reference,
                            Rcpp::IntegerMatrix reference_idx,
                            Rcpp::NumericMatrix query, Rcpp::IntegerMatrix idx,
                            Rcpp::NumericMatrix dist, const std::string metric,
                            const std::size_t max_candidates,
                            const std::size_t n_iters, const double delta,
                            bool low_memory, bool parallelize,
                            std::size_t grain_size, std::size_t block_size,
                            bool verbose);
RcppExport SEXP _rnndescent_nn_descent_query(
    SEXP referenceSEXP, SEXP reference_idxSEXP, SEXP querySEXP, SEXP idxSEXP,
    SEXP distSEXP, SEXP metricSEXP, SEXP max_candidatesSEXP, SEXP n_itersSEXP,
    SEXP deltaSEXP, SEXP low_memorySEXP, SEXP parallelizeSEXP,
    SEXP grain_sizeSEXP, SEXP block_sizeSEXP, SEXP verboseSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<Rcpp::NumericMatrix>::type reference(
      referenceSEXP);
  Rcpp::traits::input_parameter<Rcpp::IntegerMatrix>::type reference_idx(
      reference_idxSEXP);
  ...
  Rcpp::traits::input_parameter<bool>::type verbose(verboseSEXP);
  rcpp_result_gen = Rcpp::wrap(
      nn_descent_query(reference, reference_idx, query, idx, dist, metric,
                       max_candidates, n_iters, delta, low_memory, parallelize,
...
Rcpp::List random_knn_cpp(Rcpp::NumericMatrix data, int k,
                          ...
                          std::size_t block_size, std::size_t grain_size,
                          bool verbose);
RcppExport SEXP _rnndescent_random_knn_cpp(
    SEXP dataSEXP, SEXP kSEXP, SEXP metricSEXP, SEXP parallelizeSEXP,
    SEXP block_sizeSEXP, SEXP grain_sizeSEXP, SEXP verboseSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  ...
  Rcpp::traits::input_parameter<std::size_t>::type grain_size(grain_sizeSEXP);
  Rcpp::traits::input_parameter<bool>::type verbose(verboseSEXP);
  rcpp_result_gen = Rcpp::wrap(random_knn_cpp(data, k, metric, parallelize,
...
RcppExport SEXP _rnndescent_random_knn_query_cpp(
    SEXP referenceSEXP, SEXP querySEXP, SEXP kSEXP, SEXP metricSEXP,
    SEXP parallelizeSEXP, SEXP block_sizeSEXP, SEXP grain_sizeSEXP,
    SEXP verboseSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<bool>::type verbose(verboseSEXP);
  rcpp_result_gen =
      Rcpp::wrap(random_knn_query_cpp(reference, query, k, metric, parallelize,
                                      block_size, grain_size, verbose));
  return rcpp_result_gen;
  END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rnndescent_rnn_brute_force_query",
     (DL_FUNC)&_rnndescent_rnn_brute_force_query, 8},
    {"_rnndescent_nn_descent", (DL_FUNC)&_rnndescent_nn_descent, 12},
    {"_rnndescent_nn_descent_query", (DL_FUNC)&_rnndescent_nn_descent_query,
     14},
    {"_rnndescent_random_knn_cpp", (DL_FUNC)&_rnndescent_random_knn_cpp, 7},
    {"_rnndescent_random_knn_query_cpp",
     (DL_FUNC)&_rnndescent_random_knn_query_cpp, 8},
    {NULL, NULL, 0}};
