...
qnbrs4 <- nnd_knn_query(reference = ui6, reference_nn = ui6_nnd, query = ui4, k = 4, metric = "manhattan")
...
qnbrs6 <- nnd_knn_query(reference = ui4, reference_nn = ui4_nnd, query = ui6, k = 4, metric = "manhattan")
